...
var wordsToCompareSaved = ["selfie","netflix.and.chill","broccoli"];
var wordsToCompare = ["selfie","netflix.and.chill","broccoli"];
...
if( /Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
  ...
  wordsToCompareSaved = ["selfie","broccoli"];
  ...
  function topListNew(topListData){
    ...
    var topListItemDefinition = topListItem
      ...
      .attr("href",function(d){
        return "https://www.google.com/search?q=what%20is%20the%definition%20of%20"+d.term.replace(/\./g,'%20');
      })
      .attr("target","_blank")
      .append("div")
    ...
    var widthLineWideInitial = Math.min(viewportWidth,1050);
    ...
    var topListLineWideContainerSource = topListLineWideContainer.append("div")
      ...
      .style("top",function(d){
        ...
        return heightLineWide+marginLineWide.top+marginLineWide.bottom+25+"px"
      })
      .style("left",function(){
        if(mobile){
          return null;
    ...
    var iframeOne = "<iframe src='https://googletrends.github.io/year-in-language/full_blog.html' frameborder='0'></iframe>";
    var inputOne = '<input class="embed-input" readonly="true" value="'+iframeOne+'">';

    var iFrameOneDisplayed = false;
    var embedText = topListLineWideContainerSource
      .append("p")
      .attr("class","top-list-new-wide-svg-source-embed")
      .html("Embed This Chart")
      .on("click",function(d){
        if(!iFrameOneDisplayed){
          iFrameOneDisplayed = true;
          d3.select(this).html('Paste this code into your site: '+inputOne)
        }
      })
      ;
    ...
    var xWideFull = d3.scaleLinear().domain([0,214]).range([0,Math.min(viewportWidth,1050)-marginLineWide.left-fullTextWidth-rightSpacing]);
...
//        return "<tspan x='"+marginLineWide.left+"' dy='0'>Peak </tspan><tspan x='"+marginLineWide.left+"' dy='12'>&ldquo;"+compareWord.term.replace(/\./g,' ')+"&rdquo;</tspan>";
    ...
    if(mobile){
      topListLineWideContainerCloudSelector = topListLineWideContainer.append("div").attr("class","mobile-word-selector");
    }
    ...
    var terms = termsWrapper
      ...
      .html(function(d,i) {
        if(i%25==0){
          return "<span class='year-right-col' style=''>"+d.year+"</span><span class='number' style='font-size:10px;'>"+(i%25+1)+". </span><span class='cloud-term'>"+d.term.replace("."," ")+"</span>";
        }
        return "<span class='number' style='font-size:10px;'>"+(i%25+1)+". </span><span class='cloud-term'>"+d.term.replace("."," ")+"</span>";
      })
      .on("click",function(d){
        var word = d.term;
        ...
        if(wordsToCompare.indexOf(d.term) == -1){
          ...
          if(d.termMax > yWideCompareMax){
            ...
            yWideFull.domain([0,yWideCompareMax*1.1]);
    ...
    function compareFull(){
      ...
      iframeOne = "<iframe src='full.html' frameborder='0'></iframe>";
      inputOne = '<input class="embed-input" readonly="true" value="'+iframeOne+'">';

      iFrameOneDisplayed = false;
      // embedText
      //   .style("display","block")
      //   .html("Embed This Chart")
      //   ;
    ...
    //       if(e.target.controller().info("scrollDirection") == "REVERSE"){
    //
    //         iframeOne = "<iframe src='first.html' frameborder='0'></iframe>";
    //         inputOne = '<input class="embed-input" readonly="true" value="'+iframeOne+'">';
    //
    //         iFrameOneDisplayed = false;
    //         embedText
    //           .style("display","block")
    //           .html("Embed This List")
    //           ;
    //
    //         topListLineWideContainerSource
    //           .style("left",function(){
...
//    var colorsHeat = ["#ffffb2","#fed976","#feb24c","#fd8d3c","#f03b20","#bd0026","#ab0623"];
  ...
  //     ;
  //
  //     var iframeTwo = "<iframe src='geo.html' frameborder='0'></iframe>";
  ...
  //     .html("Embed This Chart")
  //     .on("click",function(d){
  //       if(!iFrameTwoDisplayed){
  //         iFrameTwoDisplayed = true;
  //         d3.select(this).html('Paste this code into your site: '+inputTwo)
  //       }
  //     })
  //     ;
  //
