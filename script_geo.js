...
//  ,weeklyCombined
  ...
  // for (var term in weeklyCombined){
  //   var volumeCumulative = 0;
  //
  //   var rollingMap = movingAvg(weeks.map(function(d,i){
  //     return [i,+weeklyCombined[term][d]];
  //   }),1).map(function(d){return d[1]});
  //
  //   var weeksMap = weeks.map(function(d){
  //     var volume = +weeklyCombined[term][d];
  //     volumeCumulative = volumeCumulative + volume;
  //     return {"date":d,"volume":+weeklyCombined[term][d],"cumulative_volume":+volumeCumulative}
  //   });
  //
  //   weeklyCombined[term].weekArray = weeksMap;
  //   weeklyCombined[term].rollingAverage = rollingMap;
  //
  //   maxValues.push(d3.max(weeklyCombined[term].weekArray, function(d){ return +d.volume }));
  // }
  ...
  function topListNew(topListData){
    ...
    var iframeOne = "<iframe src='first.html' frameborder='0'></iframe>";
...
//        return "<tspan x='"+marginLineWide.left+"' dy='0'>Peak </tspan><tspan x='"+marginLineWide.left+"' dy='12'>&ldquo;"+compareWord.term.replace(/\./g,' ')+"&rdquo;</tspan>";
    ...
    // termsWrapper.append("div")
    //   .attr("class","horz-word-cloud-show-more-container")
    //   .append("p")
    //   .attr("class","horz-word-cloud-show-more")
    //   .html(function(d){
    //     return "more &lsquo;" + d.key.slice(-2);
    //   })
    //   .on("click",function(d){
    //     var year = +d.key;
    //     d3.select(this).remove();
    //     termsWrapper.filter(function(d){
    //       return +d.key == year;
    //     })
    //     .selectAll("div")
    //     .style("display","flex");
