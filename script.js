...
function ready(error
  ...
  function topListNew(topListData){
    ...
    var iframeOne = "<iframe src='https://googletrends.github.io/year-in-language/first.html' frameborder='0'></iframe>";
...
//        return "<tspan x='"+marginLineWide.left+"' dy='0'>Peak </tspan><tspan x='"+marginLineWide.left+"' dy='12'>&ldquo;"+compareWord.term.replace(/\./g,' ')+"&rdquo;</tspan>";
    ...
    var wideScreenTopCompare = topListLineWideContainer
      ...
      .style("height",(yWideFull(rareWordThreshold)+2)+"px")
    ...
    var wideScreenTop = topListLineWideContainer
      ...
      .style("top",function(d){
        return (yWide(rareWordThreshold)-wideScreenTopHeight+marginLineWide.top-2)+"px";
      })
      .style("left",marginLineWide.left+"px")
      .style("width",function(){
        if(mobile){
    ...
    function scatterChart(){
      ...
      topListItem
        ...
        .style("top",function(d){
          return yWide(rareWordThreshold)+"px";
        })
        .style("width",lineWidth+"px")
    ...
    function compareMax(){
      ...
      wideScreenTop
        ...
        .style("top",(yWide(rareWordThreshold)-wideScreenTopHeight+marginLineWide.top)+"px")
        .transition()
        .duration(0)
    ...
    function compareFull(){
      ...
      iframeOne = "<iframe src='https://googletrends.github.io/year-in-language/full.html' frameborder='0'></iframe>";
    ...
    sectionScrollScene = new ScrollMagic.Scene({
        ...
        .on("enter",function(e){
          ...
          if(e.target.controller().info("scrollDirection") == "REVERSE"){
            ...
            iframeOne = "<iframe src='https://googletrends.github.io/year-in-language/first.html' frameborder='0'></iframe>";
            inputOne = '<input class="embed-input" readonly="true" value="'+iframeOne+'">';
            ...
            yWide.domain([0,rareWordThreshold*1.25]);
...
//    var colorsHeat = ["#ffffb2","#fed976","#feb24c","#fd8d3c","#f03b20","#bd0026","#ab0623"];
  ...
  var colorsHeat = ["#ffffb2","#fed976","#fd8d3c","#f03b20","#bd0026","#ab0623"];
    ...
    var heatMapContainerRegion = heatMapContainer
      ...
      var iframeTwo = "<iframe src='https://googletrends.github.io/year-in-language/geo.html' frameborder='0'></iframe>";
