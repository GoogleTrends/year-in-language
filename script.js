...
function ready(error
  ...
  function topListNew(topListData){
    ...
    var titles = {
      ...
      fourth:{main:"The Rise And Fall Of 50+ Slang Words",sub:"Search interest&#185; of slang terms, 2013 - 2016"}
    }
    ...
    var iframeOne = "<iframe src='https://googletrends.github.io/year-in-slang/first.html' frameborder='0'></iframe>";
...
//        return "<tspan x='"+marginLineWide.left+"' dy='0'>Peak </tspan><tspan x='"+marginLineWide.left+"' dy='12'>&ldquo;"+compareWord.term.replace(/\./g,' ')+"&rdquo;</tspan>";
    ...
    function compareFull(){
      ...
      iframeOne = "<iframe src='https://googletrends.github.io/year-in-slang/full.html' frameborder='0'></iframe>";
    ...
    sectionScrollScene = new ScrollMagic.Scene({
        ...
        .on("enter",function(e){
          ...
          if(e.target.controller().info("scrollDirection") == "REVERSE"){
            ...
            iframeOne = "<iframe src='https://googletrends.github.io/year-in-slang/first.html' frameborder='0'></iframe>";
            inputOne = '<input class="embed-input" readonly="true" value="'+iframeOne+'">';
...
//    var colorsHeat = ["#ffffb2","#fed976","#feb24c","#fd8d3c","#f03b20","#bd0026","#ab0623"];
  ...
  var colorsHeat = ["#ffffb2","#fed976","#fd8d3c","#f03b20","#bd0026","#ab0623"];
    ...
    var heatMapContainerRegion = heatMapContainer
      ...
      var iframeTwo = "<iframe src='https://googletrends.github.io/year-in-slang/geo.html' frameborder='0'></iframe>";
